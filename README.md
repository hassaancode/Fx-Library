...
| :--- | :--- | :--- | :--- |
| **[Boris Fx Sapphire](https://borisfx.com/products/sapphire/)** | AE, Resolve | Paid | Massive collection of effects, flares, and glows. |
...
| **[Signal](https://aescripts.com/signal/)** | After Effects | Paid | Analog video glitch emulation. |
| **[Pixel Sorter](https://aescripts.com/pixel-sorter/)** | After Effects | Paid | Glitch effect based on pixel sorting algorithms. |
| **[Supercomp](https://www.maxon.net/en/product-detail/red-giant/vfx/supercomp)** | After Effects | Paid | Seamless compositing of VFX elements. |
...
| Plugin | Compatibility | Price | Description |
| :--- | :--- | :--- | :--- |
| **[Dehancer](https://www.dehancer.com/)** | AE, Resolve | Paid | Complete film emulation (Grain, Bloom, Halation). |
...
| Plugin | Compatibility | Price | Description |
| :--- | :--- | :--- | :--- |
| **[Plexus](https://aescripts.com/plexus/)** | After Effects | Paid | Procedural particle engine for connected structures. |
| **[GeoLayers 3](https://aescripts.com/geolayers/)** | After Effects | Paid | Map design and animation. |
| **[Newton 4](https://aescripts.com/newton/?)** | After Effects | Paid | 2D physics engine for realistic motion. |
| **[DUIK Bassel](https://rxlaboratory.org/tools/duik-bassel/)** | After Effects | Free | Comprehensive rigging and animation toolset. |
| **[Animation Composer](https://misterhorse.com/animation-composer)** | After Effects | Freemium | Library of motion presets and transitions. |
| **[MagicZoom](https://mralextech.com/)** | DaVinci Resolve | Free | Dynamic zooms and camera movements. |
| **[MagicAnimate](https://mralextech.com/)** | DaVinci Resolve | Free | Easy animation tools for footage and elements. |
| **[mTitle / mGraph](https://www.motionvfx.com/store,mtitle-max,p2259.html?)** | DaVinci Resolve | Paid | High-quality motion graphics and title packs. |
...
| Plugin | Compatibility | Price | Description |
| :--- | :--- | :--- | :--- |
| **[Element 3D](https://www.videocopilot.net/products/element2/)** | After Effects | Paid | Import and render 3D models. |
| **[mTracker 3D](https://www.motionvfx.com/store,mtracker-3d,p4822.html?)** | DaVinci Resolve | Paid | 3D camera tracking and object placement. |
| **[Lockdown](https://aescripts.com/lockdown/)** | After Effects | Paid | Track warping surfaces and attach 3D objects. |
| **[Shadow Studio 3](https://aescripts.com/shadow-studio/)** | After Effects | Paid | Ray-traced shadows and lighting simulation. |
| **[Helium](https://aescripts.com/helium/)** | After Effects | Paid | 3D toolset for motion graphics. |
...
| Plugin | Compatibility | Price | Description |
| :--- | :--- | :--- | :--- |
| **[Mocha Pro](https://borisfx.com/products/mocha-pro/)** | AE, Resolve | Paid | Planar tracking, rotoscoping, and object removal. |
| **[Neat Video](https://www.neatvideo.com/)** | AE, Resolve | Paid | Advanced noise reduction. |
| **[FX Console](https://www.videocopilot.net/blog/2018/05/fx-console-updated-to-v1-0-3/)** | After Effects | Free | Workflow utility for fast effect application. |
| **[Reactor](https://www.fusion3design.com/reactor-download/)** | DaVinci Resolve | Free | Community package manager for Fusion/Resolve. |
| **[Overlord](https://www.battleaxe.co/overlord)** | After Effects | Paid | Seamless transfer between Illustrator and After Effects. |
